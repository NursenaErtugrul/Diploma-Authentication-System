...
class App extends Component {
  ...
  add = data => {
    ...
    //console.log(data.fname, data.departman, data.email);
    var name = data.fname + " " + data.lname;
    certcontract.methods.addcert(name, data.departman, data.snumber).send(
      {
      ...
      (error, result) => {
        if (error) console.log("error " + error);
          ...
          this.setState({snumber: data.snumber});
          this.setState({ departman: data.departman + " " + "\n"+" Department" });
          ...
          <Route
            ...
            component={() => (
              <Certificate
                ...
                departman={this.state.departman}
